...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      updateName(){
        let that = this;
        axios.post("/api/api/userdb/updata_user_name",{phonenumber: that.phonenumber,newname: that.newname})
        .then(function(response){
      ...
      refreshKey(){
        let that = this;
        axios.post("/api/api/userdb/refresh_key",{phonenumber: that.phonenumber})
        .then(function(response){
      ...
      onDestroy(){
        let that = this;
        axios.post('/api/api/userdb/destroy_userdata',{phonenumber: that.phonenumber}).then(function(response){
